...
const Cta = () => {
  return (
    <div className='container mx-auto flex flex-col gap-5 items-center justify-center py-20'>
            <p className=' text-xl md:text-2xl lg:text-4xl font-medium text-center'>Contact Us Today</p>
            <p className='text-base sm:text-lg lg:text-2xl font-medium text-center'>Be part of the new wave of business connections</p>
