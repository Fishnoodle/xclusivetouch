...
const MoreInfoModal = () => {
  const info=[
    ...
    {
      title:"How does XclusiveTouch get the other person's information",
      des:"Your profile comes with two main buttons for people to navigate to. In addition to your social accounts and contacts details people can either save your contact or Exchange Contact with you. Our lead capture feature allows people to quikcly enter their name, email, and any other information they wish to share with you. We email their details to you and your detail to them"
    }
  ]
  return (
